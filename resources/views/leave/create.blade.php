                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('leaves.store') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-5">
                                <input id="subject" type="text" placeholder="Subject" class="form-control{{ $errors->has('subject') ? ' is-invalid' : '' }}" name="subject" value="{{ old('subject') }}" required autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <a class="btn btn-link" href="/leaves">
                                    Cancel
                                </a>
                            </div>
                        </div>
